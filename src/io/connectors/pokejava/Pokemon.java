...
public class Pokemon extends ModelClass {
	...
	public void setDescriptions(ArrayList<Integer> descriptions) {
		Descriptions = descriptions;
	}

	public void setEvolutions(ArrayList<Integer> evolutions) {
		Evolutions = evolutions;
	}

	public void setEggGroups(ArrayList<Integer> eggGroups) {
		EggGroups = eggGroups;
	}
	...
	public void setLearnTypes(ArrayList<String> learnTypes) {
